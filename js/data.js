...
const STATIC_STANDINGS = {
  baseball: [
    { label:'MLB 美聯東區', lid:'MLB', headers:['球隊','勝','敗'],
      rows:[['Tampa Bay Rays','37','25'],['New York Yankees','38','26'],['Toronto Blue Jays','32','34'],['Baltimore Orioles','31','35'],['Boston Red Sox','27','36']] },
    { label:'MLB 美聯中區', lid:'MLB', headers:['球隊','勝','敗'],
      rows:[['Cleveland Guardians','37','30'],['Chicago White Sox','34','31'],['Minnesota Twins','30','37'],['Detroit Tigers','27','39'],['Kansas City Royals','27','39']] },
    { label:'MLB 美聯西區', lid:'MLB', headers:['球隊','勝','敗'],
      rows:[['Seattle Mariners','34','32'],['Texas Rangers','32','33'],['Athletics','31','34'],['Houston Astros','30','37'],['Los Angeles Angels','25','41']] },
    { label:'MLB 國聯東區', lid:'MLB', headers:['球隊','勝','敗'],
      rows:[['Atlanta Braves','45','21'],['Philadelphia Phillies','35','30'],['Washington Nationals','33','33'],['Miami Marlins','31','35'],['New York Mets','29','36']] },
    { label:'MLB 國聯中區', lid:'MLB', headers:['球隊','勝','敗'],
      rows:[['Milwaukee Brewers','40','23'],['St. Louis Cardinals','35','28'],['Chicago Cubs','34','31'],['Pittsburgh Pirates','34','32'],['Cincinnati Reds','31','33']] },
    { label:'MLB 國聯西區', lid:'MLB', headers:['球隊','勝','敗'],
      rows:[['Los Angeles Dodgers','42','24'],['Arizona Diamondbacks','34','31'],['San Diego Padres','33','31'],['San Francisco Giants','26','39'],['Colorado Rockies','24','42']] },
    ...
    { label:'日職 NPB 央聯', lid:'日職', headers:['球隊','勝','敗','平'],
      rows:[['阪神虎','38','22','2'],['讀賣巨人','35','25','2'],['廣島東洋鯉魚','32','28','2'],['中日龍','28','32','2'],['橫濱DeNA海灣之星','26','34','2'],['東京養樂多燕子','22','38','2']] },
    { label:'日職 NPB 太平洋聯', lid:'日職', headers:['球隊','勝','敗','平'],
      rows:[['福岡軟銀鷹','42','18','2'],['歐力士猛牛','36','24','2'],['千葉羅德海洋','33','27','2'],['埼玉西武獅','28','32','2'],['東北樂天金鷹','26','34','2'],['北海道日本火腿鬥士','22','38','2']] },
  ],
  basketball: [
    { label:'NBA 東區 2025-26', lid:'NBA', headers:['球隊','勝','敗','勝率'],
      rows:[['Detroit Pistons','60','22','.732'],['Boston Celtics','56','26','.683'],['New York Knicks','53','29','.646'],['Cleveland Cavaliers','52','30','.634'],['Toronto Raptors','46','36','.561'],['Atlanta Hawks','46','36','.561'],['Philadelphia 76ers','45','37','.549'],['Orlando Magic','45','37','.549'],['Charlotte Hornets','44','38','.537'],['Miami Heat','43','39','.524'],['Milwaukee Bucks','32','50','.390'],['Chicago Bulls','31','51','.378'],['Brooklyn Nets','20','62','.244'],['Indiana Pacers','19','63','.232'],['Washington Wizards','17','65','.207']] },
    { label:'NBA 西區 2025-26', lid:'NBA', headers:['球隊','勝','敗','勝率'],
      rows:[['OKC Thunder','64','18','.780'],['San Antonio Spurs','62','20','.756'],['Denver Nuggets','54','28','.659'],['Los Angeles Lakers','53','29','.646'],['Houston Rockets','52','30','.634'],['Minnesota Timberwolves','49','33','.598'],['Phoenix Suns','45','37','.549'],['LA Clippers','42','40','.512'],['Portland Trail Blazers','42','40','.512'],['Golden State Warriors','37','45','.451'],['New Orleans Pelicans','26','56','.317'],['Dallas Mavericks','26','56','.317'],['Memphis Grizzlies','25','57','.305'],['Sacramento Kings','22','60','.268'],['Utah Jazz','22','60','.268']] },
    ...
    { label:'CBA 2025-26 積分榜', lid:'CBA', headers:['球隊','勝','負'],
      rows:[['廣東宏遠','38','6'],['北京首鋼','35','9'],['遼寧本鋼','33','11'],['上海久事','30','14'],['浙江稠州','27','17'],
            ['新疆廣匯','25','19'],['山東高速','24','20'],['江蘇肯帝亞','22','22'],['深圳馬可波羅','20','24'],['廣州龍獅','18','26'],
            ['同曦體育','17','27'],['四川金強','16','28'],['吉林東北虎','15','29'],['天津先行者','14','30'],['廣廈豪勇','13','31'],
            ['南京頭排','12','32'],['九台農商','11','33'],['青島國信','10','34'],['福建晉江文旅','9','35'],['山西汾酒','8','36']] },
    { label:'B1 League 東區 2025-26', lid:'BLeague', headers:['球隊','勝','負'],
      rows:[['宇都宮Brex','45','15'],['千葉Jets','42','18'],['群馬Crane Thunders','42','18'],['Alvark Tokyo','41','19'],['北海道Levanga','37','23'],
            ['仙台89ers','33','27'],['橫濱B-Corsairs','30','30'],['Sunrockers Shibuya','28','32'],['越谷Alphas','25','35'],['茨城Robots','22','38'],
            ['湘南United','20','40'],['仙台89ers B','18','42']] },
    { label:'B1 League 西區 2025-26', lid:'BLeague', headers:['球隊','勝','負'],
      rows:[['琉球Golden Kings','50','10'],['名古屋Diamond Dolphins','44','16'],['大阪Evessa','40','20'],['三遠NeoPhoenix','36','24'],['京都Hannaryz','33','27'],
            ['秋田Northern Happinets','30','30'],['廣島Dragonflies','28','32'],['富山Grouses','25','35'],['長崎Velca','22','38'],['西宮Storks','20','40'],
            ['信州Brave Warriors','18','42'],['佐賀Ballooners','16','44'],['島根智慧鸛','15','45'],['熊本Volters','12','48']] },
  ],
  soccer: [
  ...
  tennis: [
    { label:'ATP 世界排名 2026', lid:'ATP', headers:['球員','積分'],
      rows:[['Jannik Sinner','14,750'],['Carlos Alcaraz','11,960'],['Alexander Zverev','5,705'],['Novak Djokovic','4,460'],['Ben Shelton','4,070'],['Felix Auger-Aliassime','4,050'],['Alex de Minaur','3,855'],['Daniil Medvedev','3,760'],['Holger Rune','3,420'],['Casper Ruud','3,210']] },
    { label:'WTA 世界排名 2026', lid:'WTA', headers:['球員','積分'],
      rows:[['Aryna Sabalenka','9,960'],['Elena Rybakina','8,313'],['Iga Swiatek','7,273'],['Coco Gauff','6,749'],['Jessica Pegula','6,286'],['Amanda Anisimova','5,958'],['Elina Svitolina','4,315'],['Mirra Andreeva','4,181'],['Emma Raducanu','3,876'],['Qinwen Zheng','3,654']] },
  ],
};
